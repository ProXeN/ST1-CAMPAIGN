...
[{(mission_AI_controller)}, {
	...
	_medGroup = [ "O_soldier_TL_F", "O_medic_F", "O_soldier_F", "O_soldier_F" ]; //Grupo de 3 hombres + LSV
	...
	[        //Grupo    //Punto de spawn //Son solo Inf? //Bando     //Tarea         //Piden refuerzos? //Dan apoyo a otros grupos?  //False si task es DEFEND/DEFEND_BASE
		...
		[ [  _smallGroup, "mZone_1", true, EAST ], [ "PATROL" ], [true, true, true] ],
		[ [  _bigGroup, "mZone_1", true, EAST ], [ "LOITER" ], [true, true, true] ],
		[ [  _smallGroup, "mZone_1", true, EAST ], [ "OCCUPY" ], [true, true, true] ]
	];

	unitsZone2 =
	[
		[ [  _smallGroup, "mZone_2", true, EAST ], [ "PATROL_URBAN" ], [true, true, true] ],
    [ [  _smallGroup, "mZone_2", true, EAST ], [ "PATROL_URBAN" ], [true, true, true] ],
    [ [  _smallGroup, "mZone_2", true, EAST ], [ "DEFEND" ], [true, true, true] ],
		[ [  _bigGroup, "mGar_1", true, EAST ], [ "GARRISON" ]],
		[ [  _bigGroup, "mGar_2", true, EAST ], [ "GARRISON" ]],
		[ [  _bigGroup, "mGar_3", true, EAST ], [ "GARRISON" ]]
	];
	...
	["unitsZone2", "mZone_2", "EAST", "WEST", 800] spawn T8U_fnc_Zone;
