class KeypadDefuse
{
	...
	class controls
	{
		...
		class KeypadImage: RscPicture
		{
			...
			h = 1.254 * safezoneH;
			text = "mission\custom-scripts\DEFUSE\explosive.paa";
		};
		...
		class Bblue: RscButton
		{
			...
			soundClick[] = {"",0,0};
			onMouseButtonDown = "playSound 'wire_cut'; [WIRE,'BLUE'] spawn COB_fnc_wireCompare; closeDialog 0";
		};
		class Bwhite: RscButton
		{
			...
			soundClick[] = {"",0,0};
			onMouseButtonDown = "playSound 'wire_cut'; [WIRE,'WHITE'] spawn COB_fnc_wireCompare; closeDialog 0";
		};
		class Byellow: RscButton
		{
			...
			soundClick[] = {"",0,0};
			onMouseButtonDown = "playSound 'wire_cut'; [WIRE,'YELLOW'] spawn COB_fnc_wireCompare; closeDialog 0";
		};
